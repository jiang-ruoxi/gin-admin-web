  ...
  <div>
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        ...
        <el-form-item label="当前选择的答案:" prop="isSelect">
          <el-input v-model="formData.isSelect" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="正确答案:" prop="rightSelect">
          <el-input v-model="formData.rightSelect" :clearable="true" placeholder="请输入" />
        </el-form-item>
