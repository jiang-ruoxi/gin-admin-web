  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        >
          ...
          <el-table-column align="left" label="OpenId" prop="open_id" width="400" />
          ...
          <el-table-column align="left" label="收藏时间" prop="add_time" width="300" />
        </el-table>
...
const getTableData = async() => {
  const table = await getLikeList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
