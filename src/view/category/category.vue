  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
          <el-table-column align="left" label="编号" prop="ID" width="200" />
        <el-table-column align="left" label="栏目名称" prop="name" width="400" />
        <el-table-column align="left" label="状态" prop="status" width="500">
            <template #default="scope">
              <el-tag type="success" v-if="scope.row.status==1"> {{ formatBoolean(scope.row.status) }}</el-tag>
              <el-tag type="warning" v-if="scope.row.status==0"> {{ formatBoolean(scope.row.status) }}</el-tag>
             </template>
        </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="100px">
        ...
        <el-form-item label="状态:"  prop="status" >
          <el-switch v-model="formData.status" active-color="#409eff" inactive-color="#dcdfe6" active-text="是" inactive-text="否" clearable ></el-switch>
        </el-form-item>
      </el-form>
      <template #footer>
